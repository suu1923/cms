  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.section-split-gallery',
...
export interface ApiFriendLinkFriendLink extends Struct.CollectionTypeSchema {
...
export interface ApiHomePageHomePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coverHero: Schema.Attribute.Component<'sections.section-cover-hero', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.section-product-categories',
        'sections.section-product-showcase',
        'sections.section-split-gallery',
        'sections.section-carousel',
        'sections.section-grid',
        'sections.section-split',
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    cover: Schema.Attribute.Media<'images'>;
    coverGallery: Schema.Attribute.Media<'images', true>;
    coverHeightMode: Schema.Attribute.Enumeration<['h_2_3', 'h_full']> &
      Schema.Attribute.DefaultTo<'h_2_3'>;
    coverTextColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#ffffff'>;
    coverTextPosition: Schema.Attribute.Enumeration<
      ['pos_left_center', 'pos_center', 'pos_left_bottom']
    > &
      Schema.Attribute.DefaultTo<'pos_left_center'>;
    coverTextSize: Schema.Attribute.Enumeration<
      ['size_s', 'size_m', 'size_l']
    > &
      Schema.Attribute.DefaultTo<'size_m'>;
    coverVideo: Schema.Attribute.Media<'videos'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    detailHeroImage: Schema.Attribute.Media<'images'>;
    enableContinuousTextOnlyDisplay: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    enableSpecialCover: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    keywords: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    i18nEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiThirdPartyContactThirdPartyContact
  extends Struct.CollectionTypeSchema {
  collectionName: 'third_party_contacts';
  info: {
    displayName: '\u7B2C\u4E09\u65B9\u8054\u7CFB\u65B9\u5F0F';
    pluralName: 'third-party-contacts';
    singularName: 'third-party-contact';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::third-party-contact.third-party-contact'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::third-party-contact.third-party-contact': ApiThirdPartyContactThirdPartyContact;
